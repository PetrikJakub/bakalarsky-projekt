...
{{--        </style>--}}
    ...
    <body class="antialiased" >
        <div class="relative flex items-top justify-center min-h-screen  sm:items-center py-4 sm:pt-0" style="background-image: url('{{ asset('images/wallpaper.jpg') }}');">
...
{{--                        <x-jet-button class=" vertical-center " type="submit">Donate</x-jet-button>--}}
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8" >
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <h1 style="color:black">Integrácia platobnej brány do webovej aplikácie</h1>
                </div>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-1000 sm:text-left">
