...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            video{max-width:100%;height:auto}.bg-white{--bg-opacity:1;background-color:#fff;background-color:rgba(255,255,255,var(--bg-opacity))}.bg-gray-100{--bg-opacity:1;background-color:#f7fafc;background-color:rgba(247,250,252,var(--bg-opacity))}.border-gray-200{--border-opacity:1;border-color:#edf2f7;border-color:rgba(237,242,247,var(--border-opacity))}
...
{{--        </style>--}}
    ...
    <div class="dark:bg-gray-800 overflow-hidden sm:rounded-lg" style="margin-left: 5%" >

        <div    class="hidden fixed top-0 left-0 sm:block">
            <h1  style="color:black; font-size: 220%">Integrácia platobnej brány do webovej aplikácie</h1><br><br>
            <div style="width: 35%; margin-left: 6% ; font-size: large;/*background-color: rgba(0,0,0,0.05);*/ padding: 3%; border-radius: 15px;">
                <h2>Prispievaci portál:</h2>
                <p style="color: #4a5568">Táto webová aplikácia obsahuje integráciu platobnej metódy a demonštruje darovanie finančných príspevkov pomocou platobných a debetných kariet. Je možné prispieť ľubovoľnú sumu alebo zvoliť si z prednastavených hodnôt.</p>
                <p>Pre realizáciu platby je potrebné sa najskôr <a href="{{ route('register') }}" class="underline">zaregistrovať.</a></p>
                <p>Ak máte vytvorený účeť, prosím kliknite na <a href="{{ route('register') }}" class="underline">prihlásenie.</a></p>
            </div>
        </div>
    </div>
...
{{--                        <x-jet-button class=" vertical-center " type="submit">Donate</x-jet-button>--}}
                        <a href="{{ url('/dashboard') }}" class="button">Úvod</a>
                    @else
            ...
            <div >
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between" >
                    ...
                    <div class="text-center text-sm text-gray-1000 sm:text-left" style="position: fixed ;bottom:0; left: 5%">
                        <div class="flex items-center">
                            ...
                            <a href = "https://is.stuba.sk/auth/lide/clovek.pl?id=8855;" class="ml-1 underline">
                            ...
                            <a href = "https://is.stuba.sk/auth/lide/clovek.pl?id=97901;" class="ml-1 underline">
                                Jakub Petrík
                            </a>
                        </div>
                    </div>
